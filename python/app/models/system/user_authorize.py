"""
Tortoise ORM model for user_authorize table
"""
...
class UserAuthorize(Model):
    ...
    Represents the user_authorize table in the OpenCart database.
    
    Attributes:
        user_authorize_id (int(11)) - Primary key
    ...
    user_authorize_id = fields.IntField(pk=True)
