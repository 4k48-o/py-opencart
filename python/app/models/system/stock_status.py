"""
Tortoise ORM model for stock_status table
"""
...
class StockStatus(Model):
    """
    StockStatus model
    
    Represents the stock_status table in the OpenCart database.
    
    Attributes:
        stock_status_id (int(11)) - Primary key
        language_id (int(11)) - Primary key
        name (varchar(32)), nullable
    """

    stock_status_id = fields.IntField(null=True)
