"""
Tortoise ORM model for article_to_store table
"""
...
class ArticleToStore(Model):
    """
    ArticleToStore model
    
    Represents the article_to_store table in the OpenCart database.
