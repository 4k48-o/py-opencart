"""
Tortoise ORM model for product_to_layout table
"""
...
class ProductToLayout(Model):
    """
    ProductToLayout model
    
    Represents the product_to_layout table in the OpenCart database.
