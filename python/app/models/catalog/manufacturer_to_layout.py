"""
Tortoise ORM model for manufacturer_to_layout table
"""
...
class ManufacturerToLayout(Model):
    """
    ManufacturerToLayout model
    
    Represents the manufacturer_to_layout table in the OpenCart database.
    ...
    class Meta:
        table = "oc_manufacturer_to_layout"
