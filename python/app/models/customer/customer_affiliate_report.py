"""
Tortoise ORM model for customer_affiliate_report table
"""
...
class CustomerAffiliateReport(Model):
    """
    CustomerAffiliateReport model
    
    Represents the customer_affiliate_report table in the OpenCart database.
    
    Attributes:
        customer_affiliate_report_id (int(11)) - Primary key
    ...
    customer_affiliate_report_id = fields.IntField(pk=True)
    ...
    class Meta:
        table = "oc_customer_affiliate_report"
